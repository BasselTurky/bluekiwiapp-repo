function createGoogleUniqePassEmail(uniqePassword) {
  let message = `
                                  ...
                                  >
                                    ...
                                    <p style="font-size: 14px; line-height: 140%">
                                      <span
                                        ...
                                        "
                                      >
                                        Thank you for using Blue Kiwi App.<br /><br />This
                                        is a temporary password generated for your
                                        convenience, allowing you to log in to
                                        your account using your email and
                                        password.<br /><br />Don't share this
                                        password with anyone.<br />Feel free to
                                        update your password directly within the
...
module.exports = { createGoogleUniqePassEmail };
